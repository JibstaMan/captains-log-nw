...
var DEFAULTS = {
  ...
  OPTIONS: {
    ...
    // allow the user to specify the console being used
    // since NWjs 0.13+, there are multiple console's
    // 1. Window (Browser context)
    // 2. Background page (Node context)
    // if the console is not specified, it defaults to 2.
    console: false,
